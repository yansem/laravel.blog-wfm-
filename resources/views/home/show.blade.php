    ...
    <div class="page-wrapper">
        <div class="blog-title-area">
            <ol class="breadcrumb hidden-xs-down">
                ...
                <li class="breadcrumb-item"><a href="{{ route('category.show', ['slug' => $post->category->slug])
                }}">{{ $post->category->title }}</a></li>
                <li class="breadcrumb-item active">{{ $post->title }}</li>
            </ol>

            <span class="color-yellow"><a href="{{ route('category.show', ['slug' => $post->category->slug])
            ...
            <div class="tag-cloud-single">
                ...
                <span>Tags</span>
                    @foreach($post->tags as $tag)
                        <small><a href="{{ route('tag.show', ['slug' => $tag->slug]) }}" title="">{{ $tag->title
                        }}</a></small>
                    @endforeach
                @endif
            </div><!-- end meta -->
